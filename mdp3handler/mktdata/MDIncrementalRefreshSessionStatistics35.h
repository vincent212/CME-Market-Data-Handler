...
public:
    ...
    static const std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(35);
    ...
    MDIncrementalRefreshSessionStatistics35() = default;
    ...
    MDIncrementalRefreshSessionStatistics35(char *buffer, const std::uint64_t bufferLength) :
        MDIncrementalRefreshSessionStatistics35(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    MDIncrementalRefreshSessionStatistics35(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        MDIncrementalRefreshSessionStatistics35(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    {
        return *this = MDIncrementalRefreshSessionStatistics35(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }

    MDIncrementalRefreshSessionStatistics35 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = MDIncrementalRefreshSessionStatistics35(
            buffer,
    ...
    MDIncrementalRefreshSessionStatistics35 &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = MDIncrementalRefreshSessionStatistics35(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }

    MDIncrementalRefreshSessionStatistics35 &sbeRewind()
    {
    ...
    {
        MDIncrementalRefreshSessionStatistics35 skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
#pragma clang diagnostic pop
    ...
    MDIncrementalRefreshSessionStatistics35 &transactTime(const std::uint64_t value) SBE_NOEXCEPT
    {
...
template<typename CharT, typename Traits>
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, MDIncrementalRefreshSessionStatistics35 _writer)
{
    MDIncrementalRefreshSessionStatistics35 writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "MDIncrementalRefreshSessionStatistics35", )";

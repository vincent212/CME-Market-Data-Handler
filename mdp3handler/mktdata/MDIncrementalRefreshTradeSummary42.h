...
public:
    ...
    MDIncrementalRefreshTradeSummary42() = default;
    ...
    MDIncrementalRefreshTradeSummary42(char *buffer, const std::uint64_t bufferLength) :
        MDIncrementalRefreshTradeSummary42(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    MDIncrementalRefreshTradeSummary42(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        MDIncrementalRefreshTradeSummary42(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    {
        return *this = MDIncrementalRefreshTradeSummary42(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }

    MDIncrementalRefreshTradeSummary42 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = MDIncrementalRefreshTradeSummary42(
            buffer,
    ...
    MDIncrementalRefreshTradeSummary42 &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = MDIncrementalRefreshTradeSummary42(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }

    MDIncrementalRefreshTradeSummary42 &sbeRewind()
    {
    ...
    {
        MDIncrementalRefreshTradeSummary42 skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
#pragma clang diagnostic pop
    ...
    MDIncrementalRefreshTradeSummary42 &transactTime(const std::uint64_t value) SBE_NOEXCEPT
    {
...
template<typename CharT, typename Traits>
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, MDIncrementalRefreshTradeSummary42 _writer)
{
    MDIncrementalRefreshTradeSummary42 writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "MDIncrementalRefreshTradeSummary42", )";

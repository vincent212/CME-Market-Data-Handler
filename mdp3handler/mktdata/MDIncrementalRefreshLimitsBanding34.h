...
public:
    ...
    static const std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(34);
    ...
    MDIncrementalRefreshLimitsBanding34() = default;
    ...
    MDIncrementalRefreshLimitsBanding34(char *buffer, const std::uint64_t bufferLength) :
        MDIncrementalRefreshLimitsBanding34(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    MDIncrementalRefreshLimitsBanding34(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        MDIncrementalRefreshLimitsBanding34(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    {
        return *this = MDIncrementalRefreshLimitsBanding34(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }

    MDIncrementalRefreshLimitsBanding34 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = MDIncrementalRefreshLimitsBanding34(
            buffer,
    ...
    MDIncrementalRefreshLimitsBanding34 &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = MDIncrementalRefreshLimitsBanding34(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }

    MDIncrementalRefreshLimitsBanding34 &sbeRewind()
    {
    ...
    {
        MDIncrementalRefreshLimitsBanding34 skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
#pragma clang diagnostic pop
    ...
    MDIncrementalRefreshLimitsBanding34 &transactTime(const std::uint64_t value) SBE_NOEXCEPT
    {
...
template<typename CharT, typename Traits>
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, MDIncrementalRefreshLimitsBanding34 _writer)
{
    MDIncrementalRefreshLimitsBanding34 writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "MDIncrementalRefreshLimitsBanding34", )";

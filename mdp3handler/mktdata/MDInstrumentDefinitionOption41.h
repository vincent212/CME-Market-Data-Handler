...
public:
    static const std::uint16_t SBE_BLOCK_LENGTH = static_cast<std::uint16_t>(213);
    static const std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(41);
    ...
    MDInstrumentDefinitionOption41() = default;
    ...
    MDInstrumentDefinitionOption41(char *buffer, const std::uint64_t bufferLength) :
        MDInstrumentDefinitionOption41(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    MDInstrumentDefinitionOption41(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        MDInstrumentDefinitionOption41(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint16_t sbeBlockLength() SBE_NOEXCEPT
    {
        return static_cast<std::uint16_t>(213);
    }
    ...
    {
        return *this = MDInstrumentDefinitionOption41(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }

    MDInstrumentDefinitionOption41 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = MDInstrumentDefinitionOption41(
            buffer,
    ...
    MDInstrumentDefinitionOption41 &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = MDInstrumentDefinitionOption41(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }

    MDInstrumentDefinitionOption41 &sbeRewind()
    {
    ...
    {
        MDInstrumentDefinitionOption41 skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionOption41 &totNumReports(const std::uint32_t value) SBE_NOEXCEPT
    {
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionOption41 &securityUpdateAction(const SecurityUpdateAction::Value value) SBE_NOEXCEPT
    {
        char val = (value);
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionOption41 &lastUpdateTime(const std::uint64_t value) SBE_NOEXCEPT
    {
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionOption41 &mDSecurityTradingStatus(const SecurityTradingStatus::Value value) SBE_NOEXCEPT
    {
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionOption41 &applID(const std::int16_t value) SBE_NOEXCEPT
    {
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionOption41 &marketSegmentID(const std::uint8_t value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionOption41 &underlyingProduct(const std::uint8_t value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionOption41 &securityExchange(const std::uint64_t index, const char value)
    {
        if (index >= 4)
        {
    ...
    MDInstrumentDefinitionOption41 &putSecurityExchange(const char *const src) SBE_NOEXCEPT
    {
        std::memcpy(m_buffer + m_offset + 19, src, sizeof(char) * 4);
        return *this;
    }

    MDInstrumentDefinitionOption41 &putSecurityExchange(
        const char value0,
        const char value1,
        const char value2,
    ...
    #if __cplusplus >= 201703L
    MDInstrumentDefinitionOption41 &putSecurityExchange(const std::string_view str)
    {
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionOption41 &securityGroup(const std::uint64_t index, const char value)
    {
        if (index >= 6)
        {
    ...
    MDInstrumentDefinitionOption41 &putSecurityGroup(const char *const src) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    MDInstrumentDefinitionOption41 &putSecurityGroup(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 6)
        {
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionOption41 &asset(const std::uint64_t index, const char value)
    {
        if (index >= 6)
        {
    ...
    MDInstrumentDefinitionOption41 &putAsset(const char *const src) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    MDInstrumentDefinitionOption41 &putAsset(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 6)
        {
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionOption41 &symbol(const std::uint64_t index, const char value)
    {
        if (index >= 20)
        {
    ...
    MDInstrumentDefinitionOption41 &putSymbol(const char *const src) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    MDInstrumentDefinitionOption41 &putSymbol(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 20)
        {
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionOption41 &securityID(const std::int32_t value) SBE_NOEXCEPT
    {
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionOption41 &securityType(const std::uint64_t index, const char value)
    {
        if (index >= 6)
        {
    ...
    MDInstrumentDefinitionOption41 &putSecurityType(const char *const src) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    MDInstrumentDefinitionOption41 &putSecurityType(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 6)
        {
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionOption41 &cFICode(const std::uint64_t index, const char value)
    {
        if (index >= 6)
        {
    ...
    MDInstrumentDefinitionOption41 &putCFICode(const char *const src) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    MDInstrumentDefinitionOption41 &putCFICode(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 6)
        {
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionOption41 &putOrCall(const PutOrCall::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionOption41 &currency(const std::uint64_t index, const char value)
    {
        if (index >= 3)
        {
    ...
    MDInstrumentDefinitionOption41 &putCurrency(const char *const src) SBE_NOEXCEPT
    {
        std::memcpy(m_buffer + m_offset + 77, src, sizeof(char) * 3);
        return *this;
    }

    MDInstrumentDefinitionOption41 &putCurrency(
        const char value0,
        const char value1,
    ...
    #if __cplusplus >= 201703L
    MDInstrumentDefinitionOption41 &putCurrency(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 3)
        {
...
public:
    SBE_NODISCARD PRICENULL &strikePrice()
    {
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionOption41 &strikeCurrency(const std::uint64_t index, const char value)
    {
        if (index >= 3)
        {
    ...
    MDInstrumentDefinitionOption41 &putStrikeCurrency(const char *const src) SBE_NOEXCEPT
    {
        std::memcpy(m_buffer + m_offset + 88, src, sizeof(char) * 3);
        return *this;
    }

    MDInstrumentDefinitionOption41 &putStrikeCurrency(
        const char value0,
        const char value1,
        const char value2) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    MDInstrumentDefinitionOption41 &putStrikeCurrency(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 3)
        {
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionOption41 &settlCurrency(const std::uint64_t index, const char value)
    {
        if (index >= 3)
        {
    ...
    MDInstrumentDefinitionOption41 &putSettlCurrency(const char *const src) SBE_NOEXCEPT
    {
        std::memcpy(m_buffer + m_offset + 91, src, sizeof(char) * 3);
        return *this;
    }

    MDInstrumentDefinitionOption41 &putSettlCurrency(
        const char value0,
        const char value1,
        const char value2) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    MDInstrumentDefinitionOption41 &putSettlCurrency(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 3)
        {
...
public:
    SBE_NODISCARD PRICENULL &minCabPrice()
    {
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionOption41 &matchAlgorithm(const char value) SBE_NOEXCEPT
    {
        char val = (value);
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionOption41 &minTradeVol(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionOption41 &maxTradeVol(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
...
public:
    SBE_NODISCARD PRICENULL &minPriceIncrement()
    {
...
public:
    SBE_NODISCARD PRICENULL &minPriceIncrementAmount()
    {
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionOption41 &tickRule(const std::int8_t value) SBE_NOEXCEPT
    {
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionOption41 &mainFraction(const std::uint8_t value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionOption41 &subFraction(const std::uint8_t value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionOption41 &priceDisplayFormat(const std::uint8_t value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionOption41 &unitOfMeasure(const std::uint64_t index, const char value)
    {
        if (index >= 30)
        {
    ...
    MDInstrumentDefinitionOption41 &putUnitOfMeasure(const char *const src) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    MDInstrumentDefinitionOption41 &putUnitOfMeasure(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 30)
        {
...
public:
    SBE_NODISCARD PRICENULL &unitOfMeasureQty()
    {
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionOption41 &clearedVolume(const std::int32_t value) SBE_NOEXCEPT
    {
        std::int32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionOption41 &openInterestQty(const std::int32_t value) SBE_NOEXCEPT
    {
        std::int32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionOption41 &userDefinedInstrument(const char value) SBE_NOEXCEPT
    {
        char val = (value);
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionOption41 &tradingReferenceDate(const std::uint16_t value) SBE_NOEXCEPT
    {
...
template<typename CharT, typename Traits>
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, MDInstrumentDefinitionOption41 _writer)
{
    MDInstrumentDefinitionOption41 writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "MDInstrumentDefinitionOption41", )";

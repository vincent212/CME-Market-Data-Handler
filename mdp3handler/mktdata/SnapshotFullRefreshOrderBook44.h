...
public:
    ...
    static const std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(44);
    ...
    SnapshotFullRefreshOrderBook44() = default;
    ...
    SnapshotFullRefreshOrderBook44(char *buffer, const std::uint64_t bufferLength) :
        SnapshotFullRefreshOrderBook44(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    SnapshotFullRefreshOrderBook44(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        SnapshotFullRefreshOrderBook44(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    {
        return *this = SnapshotFullRefreshOrderBook44(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }

    SnapshotFullRefreshOrderBook44 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = SnapshotFullRefreshOrderBook44(
            buffer,
    ...
    SnapshotFullRefreshOrderBook44 &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = SnapshotFullRefreshOrderBook44(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }

    SnapshotFullRefreshOrderBook44 &sbeRewind()
    {
    ...
    {
        SnapshotFullRefreshOrderBook44 skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
#pragma clang diagnostic pop
    ...
    SnapshotFullRefreshOrderBook44 &lastMsgSeqNumProcessed(const std::uint32_t value) SBE_NOEXCEPT
    {
...
#pragma clang diagnostic pop
    ...
    SnapshotFullRefreshOrderBook44 &totNumReports(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
...
#pragma clang diagnostic pop
    ...
    SnapshotFullRefreshOrderBook44 &securityID(const std::int32_t value) SBE_NOEXCEPT
    {
...
#pragma clang diagnostic pop
    ...
    SnapshotFullRefreshOrderBook44 &noChunks(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
...
#pragma clang diagnostic pop
    ...
    SnapshotFullRefreshOrderBook44 &currentChunk(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
...
#pragma clang diagnostic pop
    ...
    SnapshotFullRefreshOrderBook44 &transactTime(const std::uint64_t value) SBE_NOEXCEPT
    {
...
template<typename CharT, typename Traits>
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, SnapshotFullRefreshOrderBook44 _writer)
{
    SnapshotFullRefreshOrderBook44 writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "SnapshotFullRefreshOrderBook44", )";

...
public:
    static const std::uint16_t SBE_BLOCK_LENGTH = static_cast<std::uint16_t>(216);
    ...
    MDInstrumentDefinitionFuture27() = default;
    ...
    MDInstrumentDefinitionFuture27(char *buffer, const std::uint64_t bufferLength) :
        MDInstrumentDefinitionFuture27(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    MDInstrumentDefinitionFuture27(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        MDInstrumentDefinitionFuture27(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    {
        return *this = MDInstrumentDefinitionFuture27(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }

    MDInstrumentDefinitionFuture27 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = MDInstrumentDefinitionFuture27(
            buffer,
    ...
    MDInstrumentDefinitionFuture27 &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = MDInstrumentDefinitionFuture27(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }

    MDInstrumentDefinitionFuture27 &sbeRewind()
    {
    ...
    {
        MDInstrumentDefinitionFuture27 skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionFuture27 &totNumReports(const std::uint32_t value) SBE_NOEXCEPT
    {
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionFuture27 &securityUpdateAction(const SecurityUpdateAction::Value value) SBE_NOEXCEPT
    {
        char val = (value);
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionFuture27 &lastUpdateTime(const std::uint64_t value) SBE_NOEXCEPT
    {
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionFuture27 &mDSecurityTradingStatus(const SecurityTradingStatus::Value value) SBE_NOEXCEPT
    {
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionFuture27 &applID(const std::int16_t value) SBE_NOEXCEPT
    {
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionFuture27 &marketSegmentID(const std::uint8_t value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionFuture27 &underlyingProduct(const std::uint8_t value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionFuture27 &securityExchange(const std::uint64_t index, const char value)
    {
        if (index >= 4)
        {
    ...
    MDInstrumentDefinitionFuture27 &putSecurityExchange(const char *const src) SBE_NOEXCEPT
    {
        std::memcpy(m_buffer + m_offset + 19, src, sizeof(char) * 4);
        return *this;
    }

    MDInstrumentDefinitionFuture27 &putSecurityExchange(
        const char value0,
        const char value1,
        const char value2,
    ...
    #if __cplusplus >= 201703L
    MDInstrumentDefinitionFuture27 &putSecurityExchange(const std::string_view str)
    {
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionFuture27 &securityGroup(const std::uint64_t index, const char value)
    {
        if (index >= 6)
        {
    ...
    MDInstrumentDefinitionFuture27 &putSecurityGroup(const char *const src) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    MDInstrumentDefinitionFuture27 &putSecurityGroup(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 6)
        {
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionFuture27 &asset(const std::uint64_t index, const char value)
    {
        if (index >= 6)
        {
    ...
    MDInstrumentDefinitionFuture27 &putAsset(const char *const src) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    MDInstrumentDefinitionFuture27 &putAsset(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 6)
        {
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionFuture27 &symbol(const std::uint64_t index, const char value)
    {
        if (index >= 20)
        {
    ...
    MDInstrumentDefinitionFuture27 &putSymbol(const char *const src) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    MDInstrumentDefinitionFuture27 &putSymbol(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 20)
        {
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionFuture27 &securityID(const std::int32_t value) SBE_NOEXCEPT
    {
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionFuture27 &securityType(const std::uint64_t index, const char value)
    {
        if (index >= 6)
        {
    ...
    MDInstrumentDefinitionFuture27 &putSecurityType(const char *const src) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    MDInstrumentDefinitionFuture27 &putSecurityType(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 6)
        {
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionFuture27 &cFICode(const std::uint64_t index, const char value)
    {
        if (index >= 6)
        {
    ...
    MDInstrumentDefinitionFuture27 &putCFICode(const char *const src) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    MDInstrumentDefinitionFuture27 &putCFICode(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 6)
        {
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionFuture27 &currency(const std::uint64_t index, const char value)
    {
        if (index >= 3)
        {
    ...
    MDInstrumentDefinitionFuture27 &putCurrency(const char *const src) SBE_NOEXCEPT
    {
        std::memcpy(m_buffer + m_offset + 76, src, sizeof(char) * 3);
        return *this;
    }

    MDInstrumentDefinitionFuture27 &putCurrency(
        const char value0,
        const char value1,
    ...
    #if __cplusplus >= 201703L
    MDInstrumentDefinitionFuture27 &putCurrency(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 3)
        {
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionFuture27 &settlCurrency(const std::uint64_t index, const char value)
    {
        if (index >= 3)
        {
    ...
    MDInstrumentDefinitionFuture27 &putSettlCurrency(const char *const src) SBE_NOEXCEPT
    {
        std::memcpy(m_buffer + m_offset + 79, src, sizeof(char) * 3);
        return *this;
    }

    MDInstrumentDefinitionFuture27 &putSettlCurrency(
        const char value0,
        const char value1,
        const char value2) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    MDInstrumentDefinitionFuture27 &putSettlCurrency(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 3)
        {
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionFuture27 &matchAlgorithm(const char value) SBE_NOEXCEPT
    {
        char val = (value);
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionFuture27 &minTradeVol(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionFuture27 &maxTradeVol(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionFuture27 &mainFraction(const std::uint8_t value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionFuture27 &subFraction(const std::uint8_t value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionFuture27 &priceDisplayFormat(const std::uint8_t value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionFuture27 &unitOfMeasure(const std::uint64_t index, const char value)
    {
        if (index >= 30)
        {
    ...
    MDInstrumentDefinitionFuture27 &putUnitOfMeasure(const char *const src) SBE_NOEXCEPT
    {
    ...
    #if __cplusplus >= 201703L
    MDInstrumentDefinitionFuture27 &putUnitOfMeasure(const std::string_view str)
    {
        const std::size_t srcLength = str.length();
        if (srcLength > 30)
        {
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionFuture27 &openInterestQty(const std::int32_t value) SBE_NOEXCEPT
    {
        std::int32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionFuture27 &clearedVolume(const std::int32_t value) SBE_NOEXCEPT
    {
        std::int32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionFuture27 &decayQuantity(const std::int32_t value) SBE_NOEXCEPT
    {
        std::int32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionFuture27 &decayStartDate(const std::uint16_t value) SBE_NOEXCEPT
    {
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionFuture27 &originalContractSize(const std::int32_t value) SBE_NOEXCEPT
    {
        std::int32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionFuture27 &contractMultiplier(const std::int32_t value) SBE_NOEXCEPT
    {
        std::int32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionFuture27 &contractMultiplierUnit(const std::int8_t value) SBE_NOEXCEPT
    {
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionFuture27 &flowScheduleType(const std::int8_t value) SBE_NOEXCEPT
    {
        std::int8_t val = (value);
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionFuture27 &userDefinedInstrument(const char value) SBE_NOEXCEPT
    {
        char val = (value);
...
#pragma clang diagnostic pop
    ...
    MDInstrumentDefinitionFuture27 &tradingReferenceDate(const std::uint16_t value) SBE_NOEXCEPT
    {
        std::uint16_t val = SBE_LITTLE_ENDIAN_ENCODE_16(value);
...
template<typename CharT, typename Traits>
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, MDInstrumentDefinitionFuture27 _writer)
{
    MDInstrumentDefinitionFuture27 writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "MDInstrumentDefinitionFuture27", )";
